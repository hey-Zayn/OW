    ...
    >
      <div className='max-w-7xl mx-auto space-y-12'>
        <div className='text-center space-y-4'>
          ...
          >
            My <span style={{ color: 'var(--primary-color)' }}>Expertise</span>
          </h2>
          <p
            ref={subtitleRef}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <div
            ref={addToCardsRef}
            className='p-8 rounded-xl space-y-4 hover:shadow-lg transition-all duration-300 hover:-translate-y-1'
            style={{
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>Digital Analytics</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>Marketing Automation</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>CRM Platforms</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>SEO/SEM Tools</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>Web Development</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold' style={{ color: 'var(--text-color)' }}>Social Media</h3>
            <p style={{ color: '#525252' }} className='leading-relaxed'>
