    ...
    <>
      <div className="w-full h-full bg-[#010101]">
        ...
        <div className="w-full h-screen relative overflow-hidden">
          <div 
            className="absolute inset-0 bg-[url('/images/about.png')] bg-cover bg-center opacity-20"
            style={{
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 text-center">
            <div className="overflow-hidden">
              <h1 className="text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-4">
                About Us
              </h1>
            </div>
            <div className="overflow-hidden max-w-3xl">
              <p className="text-white/80 text-base sm:text-lg md:text-xl font-light">
                We transform visions into growth through innovative digital
                strategies and cutting-edge technology solutions.
              </p>
            </div>
            <div className="mt-8 overflow-hidden">
              <button className="px-6 py-2 sm:px-8 sm:py-3 bg-[#A91F1E]/30 text-white/90 font-medium rounded-lg hover:bg-[#A91F1E]/40 transition-all duration-300 backdrop-blur-md border border-[#A91F1E]/50 shadow-lg hover:shadow-[#A91F1E]/30">
                Connect Now
              </button>
            </div>
          </div>
